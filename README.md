This directory contains upload-ready code modules for the analyses used in the manuscript. The code is organized by analysis task. Each subdirectory contains the scripts needed for one analytical component.
...
- `03_empirical_tests_and_violin_plots.R`
  - performs empirical tree-length tests and plotting
...
- `05_summarize_xpehh_windows.py`
  - summarizes `XP-EHH` into windows
- `06_make_candidate_regions.py`
  - creates candidate selective-sweep regions
- `07_make_candidate_supplement.py`
  - creates the candidate-region supplement table
- `08_make_fst_deciles.py`
